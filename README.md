...
Version 1.12.1 beta release is available, which includes support for Revit 2026. [Installer is here](https://github.com/bvn-architecture/RevitBatchProcessor/releases/download/v1.12.1-beta/RevitBatchProcessorSetup_v1.12.1-beta.exe)

See the [Releases](https://github.com/bvn-architecture/RevitBatchProcessor/releases) page for [v1.12.1-beta release notes](https://github.com/bvn-architecture/RevitBatchProcessor/releases/tag/v1.12.1-beta).
...
[Installer for Revit Batch Processor v1.12.1 beta](https://github.com/bvn-architecture/RevitBatchProcessor/releases/download/v1.12.1-beta/RevitBatchProcessorSetup_v1.12.1-beta.exe)
